...
export default function Home() {
  ...
  const [sessionsData, setSessionsData] =
    useState<ISessionSummaryData[]>(sessionSummaryData);
      ...
      setSessionsData(
        data.sessions
          .map((s: any) => ({
            ...
            score: s.done
              ? data.reflections.filter((d: any) => d.session === s.id)[0]
                  .burnout_inv_id.overall + 1
              : 0,
          }))
          .reverse()
      );
  ...
  return (
    <>
      <Container>
        ...
        <Session
          data={sessionsData}
          openModalAction={() => setShowModal(true)}
        />
