...
export const startData: ISessionStartData = {
  ...
  instruction: (
    <>
      <Text.Body>
        <WhiteText>
          Based on the scoring below, indicate within the questionnaire how you felt during the sprint.{' '}
        </WhiteText>
      </Text.Body>
      <Text.Body>
        <WhiteText>The details of this questionnaire would be kept strictly between you and your supervisor.</WhiteText>
      </Text.Body>
      ...
      <Text.Body>
        <WhiteText>
          * This questionnaire does not replace nor is it intended to replace a diagnosis by mental health
          professionals.
        </WhiteText>
      </Text.Body>
    </>
