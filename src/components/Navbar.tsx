			...
			<div>
				<Link href='/' passHref style={{ textDecoration: 'none' }}>
					<StyledLink style={{
						...
						textDecoration: 'none',
						color: 'white',
					}}>Gratitude@GovTech</StyledLink>
				</Link>
			</div>
			<NavWrapper>
				<Link href='/' passHref style={{ textDecoration: 'none', color: 'white' }}>
					<ProfileButton><MdWbSunny style={{ verticalAlign: "middle", marginTop: "7px" }} /></ProfileButton>
				</Link>
				<Link href='/inbox' passHref style={{ textDecoration: 'none', color: 'white' }}>
					<InboxButton><MdAllInbox style={{ verticalAlign: "middle", marginTop: "7px" }} /></InboxButton>
				</Link>
				<Link href='/survey' passHref style={{ textDecoration: 'none', color: 'white' }}>
					<ProfileButton><MdPerson style={{ verticalAlign: "middle", marginTop: "7px" }} /></ProfileButton>
				</Link>
			</NavWrapper>
		</Nav>
	);
